...
public class OCRScanner {
            ...
            throws IOException, TesseractException
    {
        ...
        ImageIO
                .write(fopimage,
                        "jpg",
                        new File("E:\\Java Projects\\BoggleSolver\\src\\output.jpg"));

        // Instantiating the Tesseract class
        // which is used to perform OCR
        Tesseract it = new Tesseract();

        it.setDatapath("E:\\Applications\\Tess4J-3.4.8-src\\Tess4J\\tessdata");
    ...
    public static void main(String args[]) throws Exception
    {
        File f
                = new File(
                "E:\\Java Projects\\BoggleSolver\\src\\image.jpg");
